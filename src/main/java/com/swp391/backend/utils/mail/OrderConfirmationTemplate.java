...
public class OrderConfirmationTemplate {
    ...
    public static String getTemplete(String firstname, List<Order> orders) {
        String orderString = "";
        ReceiveInfo rI = orders.get(0).getReceiveInfo();
        String receiveInfo = String.format("%s, %s, %s, %s", rI.getSpecific_address(), rI.getWard().getName(), rI.getDistrict().getName(), rI.getProvince().getName());
        double total = 0;
        DecimalFormat decimalFormat = new DecimalFormat("0.00");
        for (Order order : orders)
        {
            total += order.getSellPrice();
            orderString += "<tr>\n" +
                    "                                <th># "+ order.getId() +" - "+ order.getShop().getName() + "</th>\n" +
                    "                              </tr>\n" +
                    "                              <tr>\n" +
                    "                                <td>\n" +
                    "                                  <table border=\"1\">\n" +
            ...
            for (OrderDetails orderDetails : order.getOrderDetails())
            {
                orderString += "<tr>\n" +
                        ...
                        "                                      <td>" + orderDetails.getProduct().getCategoryGroup().getName() + "</td>\n" +
                        "                                      <td>" + orderDetails.getQuantity() +"</td>\n" +
                        "                                      <td>$" + orderDetails.getSellPrice() + "</td>\n" +
                        "                                    </tr>\n";
            }
            orderString += "<tr>\n" +
        ...
        String templete = "<head>\n" +
                ...
                "                              <b>Bird Trading Platform</b>. We are pleased to\n" +
                "                              confirm that your order has been received and is\n" +
                "                              being processed.\n" +
                "                            </p>\n" +
                "                            <p>\n" +
                "                              We will deliver to you as soon as possible.. Your\n" +
                "                              order will be shipped to the following address:\n" +
                "                            </p>\n" +
                "                            <p>\n" +
                "                              <b><b>" + receiveInfo +"</b></b>\n" +
                "                            </p>\n" +
                ...
                "                            <p>Sincerely,</p>\n" +
                "                            <p><b>Bird Trading Platform</b></p>\n" +
                "                            <p>Your total cost is: <b>$"+ decimalFormat.format(total) +"</b></p>\n" +
                "                            <p>\n" +
                "                              Below are the details of the items you ordered\n" +
                "                            </p>\n" +
                ...
                "                          <a\n" +
                "                            href=\"https://github.com/hoangdinhnhat/swp391-integration\"\n" +
